...
void can_transmit(void)
{
	...
	TXB0D0 = n_id[0];			/* DataByte 0 */
	TXB0D1 = n_id[1];			/* DataByte 1 */
	TXB0D2 = n_id[2];		/* DataByte 2 */
	TXB0D3 = n_id[3];		/* DataByte 3 */
	TXB0D4 = u_st[0];			/* DataByte 4 */
	TXB0D5 = u_st[1];			/* DataByte 5 */
	TXB0D6 = u_st[2];		/* DataByte 6 */
	TXB0D7 = u_st[3];		/* DataByte 7 */
